...
function link_patron(direction) {
    try {
        ...
        for (var i = 0; i < g.sel_list.length; i++) {    
            ...
            if (direction) {
                xml += '<image src="/xul/rel_2_10_1/server/skin/media/images/patron_right_arrow.png"/>';
            } else {
                xml += '<image src="/xul/rel_2_10_1/server/skin/media/images/patron_left_arrow.png"/>';
            }
            xml += '</hbox>';
